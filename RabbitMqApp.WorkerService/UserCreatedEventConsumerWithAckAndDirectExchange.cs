...
public class UserCreatedEventConsumerWithAckAndDirectExchange(IConnection connection, ILogger<UserCreatedEventConsumerWithAck> logger) :
    BackgroundService
{
    // hooks
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await channel.BasicQosAsync(0, 50, false, cancellationToken: stoppingToken);
        ...
        await channel.BasicConsumeAsync("worker-service.user-created-event2.queue", false, consumer, cancellationToken:
            stoppingToken);
